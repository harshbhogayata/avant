...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-[110] bg-black/80 backdrop-blur-md",
      className,
    )}
    {...props}
  />
